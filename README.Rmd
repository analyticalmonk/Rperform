...
**_For integrating Rperform with your travis build, check out the instructions in the [Rperform Wiki](https://github.com/analyticalmonk/Rperform/wiki#integrating-rperform-with-travis-ci)_**.

<em>The project was initiated as a part of the [Google Summer of Code 2015](https://github.com/rstats-gsoc/gsoc2015/wiki/Test-timings-on-Travis) program.</em>
...
_For detailed information regarding Rperform's plotting functions, check out the **[Rperform Wiki](https://github.com/analyticalmonk/Rperform/wiki)**._
